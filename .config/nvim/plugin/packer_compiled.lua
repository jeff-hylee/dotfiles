...
_G.packer_plugins = {
  ...
  ["awesome-vim-colorschemes"] = {
    loaded = true,
    path = "/home/jeff/.local/share/nvim/site/pack/packer/start/awesome-vim-colorschemes",
  ...
  nerdtree = {
    loaded = true,
    path = "/home/jeff/.local/share/nvim/site/pack/packer/start/nerdtree",
    url = "https://github.com/preservim/nerdtree"
  },
  nvim = {
    loaded = true,
    path = "/home/jeff/.local/share/nvim/site/pack/packer/start/nvim",
  ...
  tagbar = {
    loaded = true,
    path = "/home/jeff/.local/share/nvim/site/pack/packer/start/tagbar",
  ...
  ["vim-airline"] = {
    loaded = true,
    path = "/home/jeff/.local/share/nvim/site/pack/packer/start/vim-airline",
